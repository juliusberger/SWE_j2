...
public final class Kopie_von_XML
{
    ...
    public static void importXML(String fileName)
    {
        ...
        try
        {
            ...
            int qualityRequirementsCounter = 0;
                ...
                if (event == XMLStreamConstants.START_ELEMENT) {
                    if(xmlStreamReader.getLocalName().equals("ProjectProperties")){
                        ...
                        if (!xmlStreamReader.getAttributeValue(0).equals("null"))
                        {
                            ...
                            qualityRequirements.get(qualityRequirementsCounter).setPriority(qualityRequirementsEntryPriority);
                        }
                        qualityRequirementsCounter++;
                    }
